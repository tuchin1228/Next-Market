      ...
      <article className='min-h-screen mt-24 relative'>
        ...
        <div className="category">
          <div className=' flex justify-center items-center my-16'>
            <Link href={'/news'}><a className='px-12 py-2 bg-gray-300 hover:bg-yellow-900 transition-all duration-200 text-white text-lg mx-3 rounded-full tracking-widest'>所有公告</a></Link>
            {
              categories.map(item => {
                return <Link href={'/news/' + item.id} key={item.id}>
                  <a className={`px-12 py-2  hover:bg-yellow-900 transition-all duration-200 text-white text-lg mx-3 rounded-full tracking-widest 
